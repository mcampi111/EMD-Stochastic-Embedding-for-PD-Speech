...
#On Laptop
#mydir_read = 'C:\\Users\\Marta\\Desktop\\Parkinson_data\\Python_code\\Data_extraction_&_preliminaries\\Results\\IMF_BL_train_test\\'
#mydir_res = 'C:\\Users\\Marta\\Desktop\\Parkinson_data\\Python_code\\System_M3\\Results_Fisher_Kernel\\'


#On Cluster -- modify these
mydir_out = '/lustre/home/ucabmc2/workspace/Python/EMD_GP_py/Logs/HC/SM3/'
mydir_read = '/lustre/home/ucabmc2/workspace/Python/EMD_GP_py/Data/'
mydir_res = '/lustre/home/ucabmc2/workspace/Python/EMD_GP_py/Results/HC/SM3/'
...
IMF_BL_train_hc_f = np.load (mydir_read + 'IMF_BL_hc_f_train.npy')
#IMF_BL_train_hc_m = np.load (mydir_read + 'IMF_BL_hc_m_train.npy')
...
N_hc_f = len(IMF_BL_train_hc_f)
#N_hc_m = len(IMF_BL_train_hc_m)
...
IMF_train_hc_f_seg = [[ IMF_BL_train_hc_f[j][imf_index][ind_sld[i]:ind_sld[i+1]] for i in range(0, len(ind_sld) -1) ] for j in range(ind[0],ind[1])]
